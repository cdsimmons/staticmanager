...
module.exports = function (grunt) {
  ...
  var cssFilesToInject = [
    //'linker/styles/libs/font-awesome.css',
    //'linker/styles/libs/bootstrap.css',
  ...
  var jsFilesToInject = [
    ...
    //'linker/js/angular-sails.js',
    'linker/js/angular-route.js',
    'linker/js/angular-file-upload.js',
      ...
      dev: {
        files: [
          ...
          },
          {
            ...
            src: ['**/*'],
            dest: '.tmp/public/linker/styles/fonts'
          },
          ...
          //{ '.tmp/public/linker/js/sails.io.js':          './bower_components/sails.io.js/dist/sails.io.js' },
          //{ '.tmp/public/linker/js/angular-sails.js':     './bower_components/angular-sails/dist/angular-sails.js' },
          { '.tmp/public/linker/js/angular-route.js':     './bower_components/angular-route/angular-route.js' },
          { '.tmp/public/linker/js/angular-file-upload.js':'./bower_components/ng-file-upload/angular-file-upload.js' },
...
//        },
    ...
    less: {
      bootstrap: {
        ...
        files: [
          { 'assets/linker/styles/libs/bootstrap.css': 'assets/linker/styles/libs/bootstrap.less' }
        ]
      },
      fontawesome: {
        options: {
        ...
        files: [
          { 'assets/linker/styles/libs/font-awesome.css': 'assets/linker/styles/libs/font-awesome.less' }
        ]
      },
      main: {
        options: {
          paths: ['assets/linker/styles']
        },
        files: [
          { '.tmp/public/linker/styles/main.css': 'assets/linker/styles/main.less' }
        ]
      }
    },
    ...
    'sails-linker': {
      ...
      prodStylesJADE: {
        ...
        files: {
          'views/**/*.jade': ['.tmp/public/linker/styles/libs/bootstrap.css', '.tmp/public/min/production-<%= pkg.version %>.css']
        }
      },
    ...
    watch: {
      ...
      assets: {
        ...
        // Assets to watch:
        files: ['assets/**/*', '!assets/linker/styles/**/*.css'],
